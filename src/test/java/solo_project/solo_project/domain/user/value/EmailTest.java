...
class EmailTest {
  ...
  @Test
  @DisplayName("생성 실패 - emailString is null ")
  ...
  @Test
  @DisplayName("생성 실패 - emailString isn't match regex - not exist @")
  ...
  @Test
  @DisplayName("생성 실패 - emailString isn't match regex - not exist @ after string")
